...
module.exports = {
  siteMetadata: {
    ...
    description: `I'm a passionate web developer with ${experienceInYears} years of professional experience specialising in frontend technologies. My personal focus lies on Vue / React and E-Commerce.`,
