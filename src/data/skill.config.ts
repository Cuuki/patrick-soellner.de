...
const technical: Skill[] = [
  ...
  { id: 't4', text: 'Sass', rating: 3, group: 'languages', isTopSkill: true },
  ...
  { id: 't9', text: 'Vue.js', rating: 3, group: 'frameworks', isTopSkill: true },
  { id: 't10', text: 'Web Components / Lit', rating: 2, group: 'frameworks', isTopSkill: false },
  { id: 't11', text: 'Next.js', rating: 2, group: 'frameworks', isTopSkill: true },
  { id: 't12', text: 'Nuxt', rating: 2, group: 'frameworks', isTopSkill: false },
  { id: 't13', text: 'Redux / Vuex', rating: 3, group: 'frameworks', isTopSkill: true },
  ...
  { id: 't16', text: 'Tailwind CSS', rating: 3, group: 'frameworks', isTopSkill: true },
  { id: 't17', text: 'Bootstrap 4', rating: 3, group: 'frameworks', isTopSkill: false },
  { id: 't18', text: 'Tailwind UI / Headless UI', rating: 2, group: 'frameworks', isTopSkill: false },
  { id: 't19', text: 'Emotion', rating: 2, group: 'frameworks', isTopSkill: false },
  { id: 't20', text: 'Styled Components', rating: 2, group: 'frameworks', isTopSkill: true },

  { id: 't21', text: 'Storybook', rating: 3, group: 'tools', isTopSkill: true },
  { id: 't22', text: 'Jest', rating: 3, group: 'tools', isTopSkill: true },
  { id: 't23', text: 'Testing Library', rating: 3, group: 'tools', isTopSkill: true },
  { id: 't24', text: 'Cypress', rating: 3, group: 'tools', isTopSkill: true },
  { id: 't25', text: 'Testcafe', rating: 2, group: 'tools', isTopSkill: false },
  { id: 't26', text: 'Playwright', rating: 1, group: 'tools', isTopSkill: true },
  ...
  { id: 't35', text: 'Docker', rating: 1, group: 'tools', isTopSkill: true },
  { id: 't36', text: 'AWS', rating: 1, group: 'tools', isTopSkill: false },
  ...
  { id: 't40', text: 'Atomic Design', rating: 3, group: 'methods', isTopSkill: false },
  { id: 't41', text: 'Block Element Modifier (BEM)', rating: 3, group: 'methods', isTopSkill: false },
  { id: 't42', text: 'Self-contained Systems (SCS)', rating: 2, group: 'methods', isTopSkill: false },
  {
    id: 't43',
  ...
  { id: 't44', text: 'Test-driven Development (TDD)', rating: 2, group: 'methods', isTopSkill: false },
  ...
  { id: 't55', text: 'Object Oriented Programming', rating: 2, group: 'methods', isTopSkill: false },
...
const strengths: Skill[] = [
  ...
  { id: 's3', text: 'Organisation', group: 'strengths', isTopSkill: false },
...
const interests: Skill[] = [
  { id: 'i1', text: 'Serien, Filme & Video Games', group: 'interests', isTopSkill: false },
  { id: 'i2', text: 'Motorräder / Harley Davidson', group: 'interests', isTopSkill: false },
  ...
  { id: 'i5', text: 'Reisen in der Natur', group: 'interests', isTopSkill: false },
  { id: 'i6', text: 'Smart Home', group: 'interests', isTopSkill: false },
  { id: 'i7', text: 'Pflanzen', group: 'interests', isTopSkill: false },
  { id: 'i8', text: 'Frontend Technologien & Methoden', group: 'interests', isTopSkill: false },
];
const interestsEn: Skill[] = [
  { id: 'i1', text: 'TV Shows, Movies & Video Games', group: 'interests', isTopSkill: false },
  { id: 'i2', text: 'Motorcycles / Harley Davidson', group: 'interests', isTopSkill: false },
  { id: 'i3', text: 'Music & Singing', group: 'interests', isTopSkill: false },
  { id: 'i4', text: 'Cross-country Trekking', group: 'interests', isTopSkill: false },
  { id: 'i5', text: 'Nature traveling', group: 'interests', isTopSkill: false },
  { id: 'i6', text: 'Smart Home', group: 'interests', isTopSkill: false },
  { id: 'i7', text: 'Plants', group: 'interests', isTopSkill: false },
  { id: 'i8', text: 'Frontend Technologies & Methods', group: 'interests', isTopSkill: false },
];
